...
def setup():
    print("""
Fandometric needs your tumblr keys in order to access your followers and following 
lists. You will only need to do this once. You can revoke its access at any time by 
going to Tumblr Settings > Apps on tumblr.com. 
""")
    ...
    print("""
After authorizing this application, you’ll be redirected to your localhost domain. 
(Your browser will most likely not load the page.) Copy the 'oauth_verifier' value 
from the url in your browser’s navigation bar and paste it below. Do not include 
the '#_=_' at the end of the url. The 'oauth_verifier' value should look similar 
to the highligted portion of the example below:
